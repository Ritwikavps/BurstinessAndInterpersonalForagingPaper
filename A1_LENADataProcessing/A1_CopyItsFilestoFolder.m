...
%Feb2021
%Edited: March 2022
%changes made to go to IVFCR Study Renamed folder and get the more
    %complete corpus of .its files from there. Also make two .csv files: one
    %with filenames and infant code, and the other with renamed and old file
    %names + infant code. Also added code to compute infant age from file
...
%SOME NOTES:
    ...
    %-Also not, as of April 2021, there is NOT_IVFCR folder in LENA_Exports (not named as such in renamed folder). 
...
%specifiy which infant ID is NOT-IVFCR
NotIvfcrId = '941';
    
cd /Users/ritwikavps/Library/CloudStorage/Box-Box/'IVFCR Study'/LENAExports_Renamed/ %Insert your path

destinationpath = '/Volumes/GoogleDrive-104060580022184327356/My Drive/research/IVFCRAndOtherWorkWithAnne/Pre_registration_followu/Data/LENAData/A1_ItsFiles'; %Insert your destination path
