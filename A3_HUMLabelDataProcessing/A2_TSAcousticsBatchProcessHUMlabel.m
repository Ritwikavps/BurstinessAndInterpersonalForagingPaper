...
AnnotFilepath = '/Volumes/GoogleDrive-104060580022184327356/My Drive/research/IVFCRAndOtherWorkWithAnne/Pre_registration_followu/Data/HUMLabelData/A2_HUMLabelData_ToWorkWithPostCleanUp/A2_EafLabelsOlpsProcessed';
...
for i = 1:numel(S) %go through files
    ...
    TSfile = strcat('/Volumes/GoogleDrive-104060580022184327356/My Drive/research/IVFCRAndOtherWorkWithAnne/Pre_registration_followu/Data/HUMLabelData/A2_HUMLabelData_ToWorkWithPostCleanUp/A3_TimeSeries/',...
            fileroot,'_TS.csv');
    if (isfile(WAVfilename) == 1) && (isfile(TSfile) == 0) %if wave file exists and if TSfile does not exist in final folder, continue
        ...
        outFile =...
            strcat('/Volumes/GoogleDrive-104060580022184327356/My Drive/research/IVFCRAndOtherWorkWithAnne/Pre_registration_followu/Data/HUMLabelData/A2_HUMLabelData_ToWorkWithPostCleanUp/TempTS/',...
            fileroot,'_TS.csv');
        ...
        movefile(outFile,'/Volumes/GoogleDrive-104060580022184327356/My Drive/research/IVFCRAndOtherWorkWithAnne/Pre_registration_followu/Data/HUMLabelData/A2_HUMLabelData_ToWorkWithPostCleanUp/A3_TimeSeries/');
