...
%Updated June 2023: Post the clean-up effort by Ritwika and Jeffrey in May
%2023, there is no need to further identify files with errors, so that
%portion of the code has been removed. 
...
% cd '/Volumes/GoogleDrive/My Drive/research/IVFCRAndOtherWorkWithAnne/Pre_registration_followu/Data/HUMLabelData/A1_HUMLabelData_CleanupPipeline/SummaryCsvAndTxtFiles'
% 
...
CopyTo = strcat(BasePath,'Data/HUMLabelData/A2_HUMLabelData_ToWorkWithPostCleanUp/A1_EafLabels');
CopyFrom = strcat(BasePath,'Data/HUMLabelData/A1_HUMLabelData_CleanupPipeline/EafFilesFromJeffreyMay2023/A5_ParsedCsvFiles_PostMay2023CleanUp/');
...
SourceTabwVocIndexPath = strcat(BasePath,'Data/HUMLabelData/A2_HUMLabelData_ToWorkWithPostCleanUp/A2_EafLabelsOlpsProcessed/EafLabelsPreOlpProcesswVocIndex/');

%go to sopurce directory (CopyFrom)
cd(CopyFrom)

copyfile('*_Edited.csv',CopyTo);
...
OlpProcessPath = strcat(BasePath,'Data/HUMLabelData/A2_HUMLabelData_ToWorkWithPostCleanUp/A2_EafLabelsOlpsProcessed/');
