...
#For pre-cleanup, use the following block of code the path to set is (and this would depend on your directory set up as well):
...
#~/Desktop/GoogleDriveFiles/research/IVFCRAndOtherWorkWithAnne/Pre_registration_followu/Data/HUMLabelData/A1_HUMLabelData_CleanupPipeline/A3_EditedEafFiles/
  setwd('~/Desktop/GoogleDriveFiles/research/IVFCRAndOtherWorkWithAnne/Pre_registration_followu/Data/HUMLabelData/A1_HUMLabelData_CleanupPipeline/A3_EditedEafFiles/')
...
#This string is sort of the switch we use to go between both cases
  CleanUpStatus = 'PostCleanUp'               #CHANGE TO 'PostCleanUp' AS NEEDED
################################################################################################################################################################################################################################
...
if (strcmp(CleanUpStatus,'PreCleanUp')){
  ...
  StrToRemoveToGetEafFnRoot = '.eaf'
  StrToAddForCsvFn = '.csv'
