...
source('~/Desktop/GoogleDriveFiles/research/IVFCRAndOtherWorkWithAnne/Pre_registration_followu/CodeForGitHub/A4_DataAnalysis/A6_ResponseAnalyses_IVIOnly/GetLmerCoeffsForAgeEffectsForResponseBetas.R')

FilePattern = '.*s_IviOnly.csv'
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#LENA day-long files
