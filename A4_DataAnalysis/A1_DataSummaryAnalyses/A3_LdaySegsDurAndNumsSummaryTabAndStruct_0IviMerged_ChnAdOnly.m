...
% Note that this is for the supplementary info for the PNAS draft, and uses segment labels *after* merging segments of the same type (CHNSP, CHNNSP, or AN) which have 0 IVI *and* 
% treats MAN and FAN as the same label categoriy of Adult (Ad or AN).
% Also note that these duration and number summaries exclude recordings at ages other than 3, 6, 9, and 18 mos.
