...
%initialise tables
OpTab = array2table(zeros(0,5));
OpTab.Properties.VariableNames = {'CategoricalSteps','InterVocInterval','ChildAgeMonth','ChildAgeDays','ChildId'};
...
for i = 1:numel(DirStruct) %go through DirStruct
    ...
    %vocs are now CHNSP
    ChildVocStruct = ComputeInterVocIntervalAndCategoricalSteps(StartTime,EndTime,AnnotationLabel,SpeakerLabels,SectionNumVec,Type1,ChildID,ChildAgeDays,ChildAgeMonths);
